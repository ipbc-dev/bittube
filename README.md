...
* If you would like a specific [version/tag](https://github.com/ipbc-dev/bittube/tags), do a git checkout for that version. eg. '2.0.0.1'. If you dont care about the version and just want binaries from master, skip this step:
